...
export default function AdaniOneDetail({
  ...
  return (
    <>
      ...
      <div className="max-w-[1200px] mx-auto px-12 flex flex-col gap-20 pt-16 pb-20">
        <Reveal>
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            <a href={insightReportHref} target="_blank" rel="noreferrer" className={buttonPrimary}>
              Insight Report Pdf
            </a>
            <a href={researchBoardHref} target="_blank" rel="noreferrer" className={buttonSecondary}>
              Full Research Board
            </a>
          </div>
          <p className={body}>{introParagraph}</p>

          <div className="grid grid-cols-1 md:grid-cols-[1fr_300px] gap-8 items-start mt-10">
            <img
        ...
        <Reveal>
          <h2 className={heading}>The Project Brief:</h2>
          <p className={body}>{projectBriefParagraph}</p>
        </Reveal>

        <Reveal>
          <h2 className={heading}>Understanding the Product First:</h2>
        ...
        <Reveal>
          <h2 className={heading}>Why Depth Over Breadth:</h2>
          <p className={body}>{whyDepthParagraph}</p>
          <p className="text-base leading-relaxed text-accent font-medium mt-6 max-w-[720px]">"{pullQuote}"</p>
        </Reveal>
        ...
        <Reveal className="flex flex-col gap-10">
          <h2 className={heading}>Research Approach:</h2>
        ...
        <Reveal className="flex flex-col gap-8 items-start">
          <img
            ...
            className="w-full h-auto block"
          />
          <a href={researchBoardHref} target="_blank" rel="noreferrer" className={buttonPrimary}>
            View Full Research Board
          </a>
        </Reveal>

        <Reveal className="flex flex-col gap-10">
          <h2 className={heading}>{whatIFoundIntro}</h2>
          <SubItems items={journeys} />
        </Reveal>

        <Reveal className="flex flex-col gap-6">
          <h2 className={heading}>{centralInsightHeading}</h2>
        ...
        <Reveal>
          <h2 className={heading}>Journey Maps:</h2>
        ...
        <Reveal>
          <h2 className={heading}>Severity and Risk Prioritization:</h2>
        ...
        <Reveal className="flex flex-col gap-10">
          <div>
            <h2 className={heading}>How This Research Creates Impact:</h2>
        ...
        <Reveal className="flex flex-col gap-6">
          <h2 className={heading}>Reflection & Learnings</h2>
          ...
          <p className="text-base leading-relaxed text-accent font-medium max-w-[720px]">"{closingQuote}"</p>
        </Reveal>
      </div>
